...
This also removes a whole class of [non-determinism](/tools/failure-taxonomy#same-input-different-output): prose invites rephrasing, and rephrasing is where substantive drift hides. A constrained schema leaves no room for the decision to change while the wording changes.
